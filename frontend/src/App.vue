...
function renderCmpChart() {
  ...
  cmpChart.setOption({
    ...
    title: {
      ...
      textStyle: { color: '#a8a0c8', fontSize: 11, fontWeight: 400, lineHeight: 16 },
      subtextStyle: { color: '#6f6987', fontSize: 10, fontWeight: 400, lineHeight: 14 },
    },
    grid: { left: 56, right: 30, top: 56, bottom: 30 },
    tooltip: {
      trigger: 'axis',
      backgroundColor: 'rgba(26,22,38,0.95)', borderColor: '#4a4370',
      textStyle: { color: '#d7dde4', fontSize: 12 },
      valueFormatter: v => v.toFixed(3),
    },
    legend: { top: 6, right: 10, textStyle: { color: '#a8a0c8' }, data: ['gt', 'baseline', 'ft'] },
    xAxis: {
      type: 'category', data: x, name: '帧号', nameLocation: 'middle', nameGap: 26,
      nameTextStyle: { color: '#6f6987', fontSize: 10 },
      axisLabel: { color: '#6f6987', fontSize: 9 },
      axisLine: { lineStyle: { color: '#332e47' } },
    },
    yAxis: {
      type: 'value', name: 'j_left (-1~1)', min: -1, max: 1,
      nameTextStyle: { color: '#6f6987', fontSize: 10 },
      axisLabel: { color: '#6f6987', fontSize: 10 }, splitLine: { lineStyle: { color: '#262233' } },
    },
    series: [
      { name: 'gt', type: 'line', showSymbol: false, lineStyle: { width: 1.6, color: '#ece7fb' }, data: fr.map(f => f.gt_jl[0]) },
      { name: 'baseline', type: 'line', showSymbol: false, lineStyle: { width: 1.2, color: '#8a7ec8', type: 'dashed' }, data: fr.map(f => f.base_jl[0]) },
      { name: 'ft', type: 'line', showSymbol: false, lineStyle: { width: 1.4, color: '#a78bfa' }, data: fr.map(f => f.ft_jl[0]) },
    ],
  }, true)
}
...
function renderChart() {
  ...
  chart.setOption({
    ...
    legend: { top: 6, right: 10, textStyle: { color: '#a8a0c8' }, data: ['j_left MSE', '按键准确率'] },
    xAxis: {
      type: 'category', data: x, name: '帧号', nameLocation: 'middle', nameGap: 26,
      nameTextStyle: { color: '#6f6987', fontSize: 10 },
      axisLabel: { color: '#6f6987', fontSize: 9 },
    ...
    yAxis: [
      {
        type: 'value', name: 'MSE', nameTextStyle: { color: '#6f6987', fontSize: 10 },
        axisLabel: { color: '#6f6987', fontSize: 10 }, splitLine: { lineStyle: { color: '#262233' } },
      },
      {
        type: 'value', name: '准确率', nameGap: 16, nameTextStyle: { color: '#6f6987', fontSize: 10 },
        axisLabel: { color: '#6f6987', fontSize: 10, formatter: v => (v * 100) + '%' }, splitLine: { show: false },
      },
    ],
    series: [
...
function renderSegChart() {
  ...
  segChart.setOption({
    ...
    title: {
      ...
      left: 'center', top: 2,
      textStyle: { color: '#a8a0c8', fontSize: 11, fontWeight: 400 },
    },
    ...
    xAxis: {
      ...
      axisLabel: { color: '#6f6987', fontSize: 10 },
      axisLine: { lineStyle: { color: '#332e47' } },
    },
    yAxis: {
      type: 'value', name: 'diff', nameTextStyle: { color: '#6f6987', fontSize: 10 },
      axisLabel: { color: '#6f6987', fontSize: 10 }, splitLine: { lineStyle: { color: '#262233' } },
    },
    series: [{
      ...
      itemStyle: {
        color: {
          ...
          colorStops: [{ offset: 0, color: '#a78bfa' }, { offset: 1, color: 'rgba(167,139,250,0.25)' }],
        },
...
function renderInferChart() {
  ...
  inferChart.setOption({
    ...
    legend: { top: 6, right: 10, textStyle: { color: '#a8a0c8' }, data: ['gt', 'pred'] },
    xAxis: {
    ...
    series: [
      { name: 'gt', type: 'line', showSymbol: true, symbolSize: 6, lineStyle: { width: 1.6, color: '#ece7fb' }, data: pts.map(p => p.gt) },
      { name: 'pred', type: 'line', showSymbol: true, symbolSize: 6, lineStyle: { width: 1.4, color: '#a78bfa' }, data: pts.map(p => p.pred) },
    ],
  }, true)
}
